...
interface WeeklyPlatformLikesSummaryProps {
...
const WeeklyPlatformLikesSummary = ({
  ...
  const computedSummaryCards = useMemo((): SummaryCardInfo[] => {
    ...
    return [
      ...
      },
      {
        ...
        description: "Kumulatif komentar personil dalam laporan mingguan ini.",
      },
      {
  ...
  const resolvedLabels: Required<LabelOverrides> = useMemo(
    () => ({
      ...
      commentContributorsTitle: "Kontributor Komentar per Subsatker",
      commentContributorsDescription:
        "Subsatker dengan jumlah komentar terbanyak selama minggu ini.",
      ...
      commentPersonnelDescription:
        "Individu dengan komentar terbanyak pada minggu ini beserta asal satker terkait.",
      likesPersonnelTitle: "Personil dengan Likes Tertinggi",
      likesPersonnelDescription:
        "Individu dengan likes terbanyak pada minggu ini beserta asal satker terkait.",
      tableTitle: "Distribusi Engagement Mingguan per Satker",
      tableSubtitle: "Data otomatis menyesuaikan minggu yang dipilih.",
      tableEmptyLabel: "Belum ada data distribusi engagement mingguan.",
      ...(labelOverrides ?? {}),
    }),
    [labelOverrides],
  );
...
export default WeeklyPlatformLikesSummary;
