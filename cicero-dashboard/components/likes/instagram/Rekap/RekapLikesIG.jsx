        ...
        <div className="relative flex flex-col gap-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <div className="grid w-full gap-3 md:max-w-2xl md:grid-cols-2">
              ...
              <label
                className="flex w-full flex-col gap-2 text-blue-900"
                htmlFor="rekap-likes-ig-status-filter"
              >
                <span className="text-[11px] uppercase tracking-[0.35em] text-blue-500">
                  Tampilkan status
                </span>
                <select
                  id="rekap-likes-ig-status-filter"
                  className="w-full rounded-xl border border-blue-200/70 bg-white px-3 py-2 text-sm text-blue-900 shadow-sm transition focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-200"
                  value={statusFilter}
          ...
          <div className="overflow-hidden rounded-2xl border border-blue-100 bg-white p-5 shadow-inner md:p-6">
            <div className="mb-4 space-y-1 text-slate-900">
              ...
              <p className="text-xs text-slate-600 md:text-sm">
                {periodeLabel ? `Periode: ${periodeLabel}` : "Periode: Seluruh data"}
                {viewLabel ? ` • Mode: ${viewLabel}` : ""}
              </p>
            </div>
            ...
            <div className="grid gap-3 md:hidden">
              {currentRows.length === 0 ? (
                ...
                currentRows.map((u, i) => {
                  ...
                  return (
                    <article
                      key={`${u.user_id || u.username || u.nama || i}-mobile-${i}`}
                    ...
                    >
                      ...
                      <dl className="space-y-1.5 text-xs text-slate-700">
                        ...
                        <div className="flex items-center justify-between gap-2">
                          <dt className="text-slate-500">Username IG</dt>
                        ...
                        <div className="flex items-center justify-between gap-2">
                          <dt className="text-slate-500">Jumlah Like</dt>
