...
export default function DashboardPage() {
  ...
  if (error)
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-100 via-fuchsia-50 to-white flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-lg text-center text-red-500 font-bold max-w-sm w-full p-6">
          {error}
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-fuchsia-50 to-white">
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-10 md:py-14">
        <div className="bg-white rounded-2xl shadow-2xl px-4 md:px-8 py-8 md:py-10">
...
// Row tetap nyaman untuk padding dan responsif
