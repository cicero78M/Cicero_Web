...
export const metadata = {
  title: "Laporan Mingguan Ditbinmas",
  description:
    "Ringkasan performa engagement Ditbinmas berdasarkan agregasi mingguan, bulanan, dan tahunan.",
};
    ...
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-sky-50 via-white to-emerald-50 text-slate-800">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-6 py-16">
        ...
        {isDitbinmasAuthorized ? (
          ...
          <section className="relative overflow-hidden rounded-3xl border border-rose-200/60 bg-white/70 p-10 text-center shadow-xl backdrop-blur">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(254,226,226,0.6),_transparent_70%)]" />
            <div className="relative space-y-3">
              <h2 className="text-2xl font-semibold text-rose-600">
                Akses Terbatas
              </h2>
              <p className="mx-auto max-w-xl text-sm text-rose-500">
                Halaman laporan mingguan hanya dapat diakses oleh Ditbinmas. Pastikan Anda masuk dengan akun Ditbinmas untuk meninjau data engagement terbaru.
              </p>
            </div>
          </section>
        )}
