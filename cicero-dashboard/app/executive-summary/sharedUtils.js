...
export const normalizePlatformPost = (
  ...
  const comments = Math.max(
    ...
    pickNestedNumeric(post, [
      ...
      "metrics.komentar_personil",
      "metrics.komentar_personel",
      "metrics.komentar_personnel",
      "metrics.comments_personil",
      "metrics.comments_personel",
      "metrics.comments_personnel",
