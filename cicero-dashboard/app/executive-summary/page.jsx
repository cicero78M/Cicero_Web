...
const LIKE_RECORD_COMMENT_FIELDS = [
  "jumlah_komentar",
  "jumlahKomentar",
  "total_komentar",
  "totalKomentar",
...
const INSTAGRAM_LIKE_FIELD_PATHS = [...LIKE_RECORD_LIKE_FIELDS];
const TIKTOK_COMMENT_FIELD_PATHS = [...LIKE_RECORD_COMMENT_FIELDS];
...
const LIKE_RECORD_TOTAL_PERSONNEL_FIELDS = [
  "jumlah_personil",
  "total_personil",
  "target_personil",
  "jumlah_target",
...
const LIKE_RECORD_COMPLIANCE_FIELDS = [
...
const LIKE_RECORD_USERNAME_FIELDS = [
  "username",
  "user_name",
  "nama_pengguna",
  "nama",
...
const LIKE_RECORD_CLIENT_ID_FIELDS = [
  "client_id",
  "clientId",
  "clientID",
  "id_client",
...
const LIKE_RECORD_CLIENT_NAME_FIELDS = [
  "nama_client",
  "client_name",
  "client",
  "nama_satker",
...
const readNumericField = (record, paths = []) => {
...
const normalizeUserKeyFromRecord = (record = {}) => {
