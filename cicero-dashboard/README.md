...
- Form **/premium/register** juga memuat context permintaan dari endpoint **`/api/premium/request/context`** untuk mengisi ulang username, Client ID, dan UUID langsung dari backend sebelum pengguna mengirim permintaan.
