...
Props halaman menangani `client_id` melalui helper bertahan terhadap nilai `Promise`/`undefined` sehingga guard Ditbinmas dan render profil tidak terganggu oleh variasi bentuk params dari Next.js.
