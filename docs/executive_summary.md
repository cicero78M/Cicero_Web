...
- Segmen "Personil dengan Komentar Tertinggi" kini menggunakan rekap bulan berjalan lewat field `topCommentPersonnel` (dihitung terpisah dari peringkat likes) sehingga daftar tetap menampilkan personel dengan komentar terbanyak meski jumlah likes-nya lebih rendah.【F:cicero-dashboard/app/executive-summary/dataTransforms.js†L1956-L1967】【F:cicero-dashboard/components/executive-summary/PlatformLikesSummary.tsx†L337-L368】
- Segmen "Personil dengan Likes Tertinggi" juga membaca data rekap bulan berjalan bila tersedia (`rekap.data_personil/personnel`) sehingga daftar tidak lagi bergantung pada agregasi lintas bulan dan tetap selaras dengan filter periode aktif.【F:cicero-dashboard/app/executive-summary/dataTransforms.js†L1510-L1699】
- Parser likes summary menormalisasi payload rekap bulanan yang dikemas sebagai objek (`data`, `chartData`, `users`, atau `records`) sehingga perhitungan "Personil dengan Likes Tertinggi" selalu memakai batch bulan berjalan meskipun backend membungkus daftar personil di properti tambahan tersebut.【F:cicero-dashboard/app/executive-summary/dataTransforms.js†L126-L184】【F:cicero-dashboard/app/executive-summary/dataTransforms.js†L545-L588】
